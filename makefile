...
VLATOR_SRC = euvm_dir/VSerialized_Comparator_tb_euvm.d euvm_dir/VSerialized_Comparator_tb_euvm_funcs.cpp obj_dir/VSerialized_Comparator_tb.cpp obj_dir/VSerialized_Comparator_tb.h
...
clean:
	rm -rf Multi_Bit_Comparator_Serialized* euvm_dir obj_dir verilator.stamp

run: Multi_Bit_Comparator_Serialized
	./Multi_Bit_Comparator_Serialized +UVM_TESTNAME=Serialized_Comparator_tb.random_test +UVM_VERBOSITY=$(VERBOSITY) +random_seed=$(SEED) # +UVM_OBJECTION_TRACE
...
Multi_Bit_Comparator_Serialized: Serialized_Comparator_tb.d 
	   euvm_dir/VSerialized_Comparator_tb_euvm.d  \
	   $(LDC2BINDIR)/import/esdl/intf/verilator/trace.d \
	   euvm_dir/verilated_vcd_d.o euvm_dir/verilated_d.o \
	   euvm_dir/VSerialized_Comparator_tb_euvm_funcs.o  \
	   obj_dir/VSerialized_Comparator_tb__ALL.a \
...
run_overide: Multi_Bit_Comparator_Serialized
	./Multi_Bit_Comparator_Serialized +UVM_TESTNAME=Serialized_Comparator_tb.random_test +UVM_VERBOSITY=$(VERBOSITY) +random_seed=$(SEED) +UVM_SET_TYPE_OVERRIDE=Multi_Bit_Comparator_Serialized.comp_item # +UVM_OBJECTION_TRACE
